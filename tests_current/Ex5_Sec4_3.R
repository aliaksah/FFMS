...
result_parallel <- ffms(data = df, method = "ffms.parallel", transforms = transforms, 
                          probs = probs, params = params, P=25,runs = 4, cores = 4)
...
result_parallel3 <- ffms(data = df, method = "ffms.parallel", transforms = transforms, 
                         probs = probs, params = params, P=50, runs = 4, cores = 4, N=1000, N.final=4000)
