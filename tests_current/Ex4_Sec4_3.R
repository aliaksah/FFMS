...
#transforms <- c("p0","p2","p3","p05","pm05","pm1","pm2","p0p0","p0p05","p0p1","p0p2","p0p3","p0pm05","p0pm1","p0pm2")
...
result_parallel <- ffms(data = df, method = "ffms.parallel", transforms = transforms, 
                          probs = probs, params = params, prob_gen = c(0, 1, 0, 1), P=25,runs = 4, cores = 4)
...
result_parallel2 <- ffms(data = df, method = "ffms.parallel", transforms = transforms, 
                           probs = probs, params = params,prob_gen = c(0, 1, 0, 1), P=25, N=1000, N.final=2000, 
                           runs = 4, cores = 4,)
